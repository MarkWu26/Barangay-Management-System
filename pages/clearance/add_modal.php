              ...
              <div class="modal-dialog modal-sm" style="width:300px !important;">
                <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <!--    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ddl_resident" id="ddl_resident" class="select2 form-control input-sm" style="width:100%">
                                ...
                                <div class="form-group">
                                    <label>Purpose:</label>
                                    <select name="txt_purpose" id="purpose" class="select2 form-control input-sm" type="text" placeholder="Purpose" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary btn-sm" name="btn_add" id="btn_add"value="Add Clearance"/>
                    </div>
                </div>
              </div>
              </form>
...
function is_available(){
    ...
    var ddl_resident = $('#ddl_resident').val();
 
    //make the ajax request to check is username available or not
    $.post("check_addmodal.php", {purpose: purpose, ddl_resident: ddl_resident}, 
    function(result)
    {
        console.log(result);
        if(result != 0)

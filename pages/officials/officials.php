                                        ...
                                        <tbody>
                                            <?php
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *, CONCAT(f_name, ' ' , m_name, ' ', l_name) as cname FROM tblofficial ");
                                                    ...
                                                    $squery = mysqli_query($con, "SELECT *, CONCAT(f_name, ' ', m_name, ' ', l_name) as cname from tblofficial where status = 'Ongoing Term' group by termend");
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        echo '
                                                        <tr>
